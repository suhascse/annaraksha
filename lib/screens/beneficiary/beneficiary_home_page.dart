...
class _BeneficiaryHomePageState extends State<BeneficiaryHomePage>
  ...
  void _onBottomNavTap(int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        _navigate(const BeneficiaryDistributionHistoryPage());
        break;
      case 2:
        _navigate(const BeneficiaryRaiseComplaintPage());
        break;
      case 3:
        _navigate(const BeneficiaryGuaranteeStatusPage());
        break;
      case 4:
        _navigate(const BeneficiaryMultilingualPage());
        break;
    }
    // Reset index back to 0 so tapping same tab again still works
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _navItem(2, Icons.report_problem_rounded, 'Complaint'),
                  _navItem(3, Icons.verified_user_rounded, 'Guarantee'),
                  _navItem(4, Icons.language_rounded, 'Language'),
                ],
              ),
            ),
          ),
  ...
  Widget _navItem(int index, IconData icon, String label) {
    ...
    const activeColor = Color(0xFFFF9B51);
    const inactiveColor = Color(0xFFBFC9D1);
